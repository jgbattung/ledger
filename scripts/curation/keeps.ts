...
const keeps: Record<string, KeepDecision> = {
  ...
  // ---- quads ----
  "Barbell_Full_Squat": { name: "Barbell Full Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Hang_Clean_-_Below_the_Knees": { name: "Below-the-Knee Hang Clean", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "forearms", "glutes", "hamstrings", "lower back", "front delts", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Box_Squat_with_Chains": { name: "Box Squat with Chains", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abductors", "adductors", "calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Cable_Hip_Adduction": { name: "Cable Hip Adduction", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: [], equipment: "cable", category: "strength", mechanic: "isolation" },
  ...
  "Clean_from_Blocks": { name: "Clean from Blocks", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "front delts", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Clean_Pull": { name: "Clean Pull", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["forearms", "glutes", "hamstrings", "lower back", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Frankenstein_Squat": { name: "Frankenstein Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "calves", "glutes", "hamstrings"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Freehand_Jump_Squat": { name: "Freehand Jump Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings"], equipment: "bodyweight", category: "strength", mechanic: "compound" },
  ...
  "Hang_Clean": { name: "Hang Clean", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "forearms", "glutes", "hamstrings", "lower back", "front delts", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Heaving_Snatch_Balance": { name: "Heaving Snatch Balance", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "forearms", "glutes", "hamstrings", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Jerk_Dip_Squat": { name: "Jerk Dip Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "calves"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Olympic_Squat": { name: "Olympic Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "One_Leg_Barbell_Squat": { name: "One Leg Barbell Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Overhead_Squat": { name: "Overhead Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "calves", "glutes", "hamstrings", "lower back", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Plie_Dumbbell_Squat": { name: "Plie Dumbbell Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "calves", "glutes", "hamstrings"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  "Power_Jerk": { name: "Power Jerk", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abs", "calves", "glutes", "hamstrings", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Power_Snatch_from_Blocks": { name: "Power Snatch from Blocks", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "forearms", "glutes", "hamstrings", "lower back", "front delts", "traps", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Smith_Single-Leg_Split_Squat": { name: "Smith Single-Leg Split Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings"], equipment: "machine", category: "strength", mechanic: "compound" },
  "Snatch": { name: "Snatch", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["biceps", "glutes", "hamstrings", "lower back", "front delts", "traps", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Snatch_Balance": { name: "Snatch Balance", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Snatch_from_Blocks": { name: "Snatch from Blocks", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "forearms", "glutes", "hamstrings", "lower back", "front delts", "traps", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Speed_Box_Squat": { name: "Speed Box Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Speed_Squats": { name: "Speed Squats", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Split_Clean": { name: "Split Clean", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "forearms", "glutes", "hamstrings", "lower back", "front delts", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Split_Jerk": { name: "Split Jerk", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["glutes", "hamstrings", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Split_Squat_with_Dumbbells": { name: "Split Squat with Dumbbells", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["glutes", "hamstrings"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  "Squat_Jerk": { name: "Squat Jerk", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "front delts", "triceps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Squat_with_Bands": { name: "Squat with Bands", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["adductors", "calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Squat_with_Chains": { name: "Squat with Chains", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["adductors", "calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Squat_with_Plate_Movers": { name: "Squat with Plate Movers", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["abductors", "adductors", "calves", "glutes", "hamstrings"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Weighted_Jump_Squat": { name: "Weighted Jump Squat", aliases: [], primaryMuscles: ["quads"], secondaryMuscles: ["calves", "glutes", "hamstrings", "lower back"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Sled_Reverse_Flye": { name: "Sled Reverse Flye", aliases: [], primaryMuscles: ["rear delts"], secondaryMuscles: [], equipment: "other", category: "strength", mechanic: "isolation" },
  // ---- side delts ----
  ...
  "Clean_Shrug": { name: "Clean Shrug", aliases: [], primaryMuscles: ["traps"], secondaryMuscles: ["forearms", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Kettlebell_Sumo_High_Pull": { name: "Kettlebell Sumo High Pull", aliases: [], primaryMuscles: ["traps"], secondaryMuscles: ["adductors", "glutes", "hamstrings", "quads", "front delts"], equipment: "kettlebell", category: "strength", mechanic: "compound" },
  "Leverage_Shrug": { name: "Leverage Shrug", aliases: [], primaryMuscles: ["traps"], secondaryMuscles: ["forearms"], equipment: "machine", category: "strength", mechanic: "isolation" },
  ...
  "Snatch_Shrug": { name: "Snatch Shrug", aliases: [], primaryMuscles: ["traps"], secondaryMuscles: ["forearms", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  // ---- triceps ----
  "Band_Skull_Crusher": { name: "Band Skull Crusher", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "band", category: "strength", mechanic: "isolation" },
  "Bench_Dips": { name: "Bench Dips", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "front delts"], equipment: "bodyweight", category: "strength", mechanic: "compound" },
  "Bench_Press_with_Chains": { name: "Bench Press with Chains", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "lats", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Board_Press": { name: "Board Press", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "forearms", "lats", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Body_Tricep_Press": { name: "Body Tricep Press", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "bodyweight", category: "strength", mechanic: "isolation" },
  "Body-Up": { name: "Body-Up", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["abs", "forearms"], equipment: "bodyweight", category: "strength", mechanic: "isolation" },
  ...
  "Cable_One_Arm_Tricep_Extension": { name: "Cable One Arm Tricep Extension", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "cable", category: "strength", mechanic: "isolation" },
  ...
  "Chain_Handle_Extension": { name: "Chain Handle Extension", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "other", category: "strength", mechanic: "isolation" },
  ...
  "Close-Grip_Push-Up_off_of_a_Dumbbell": { name: "Close-Grip Push-Up off of a Dumbbell", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["abs", "chest", "front delts"], equipment: "bodyweight", category: "strength", mechanic: "compound" },
  ...
  "Dumbbell_Tricep_Extension_-Pronated_Grip": { name: "Dumbbell Tricep Extension -Pronated Grip", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "dumbbell", category: "strength", mechanic: "isolation" },
  ...
  "Floor_Press_with_Chains": { name: "Floor Press with Chains", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Reverse_Band_Bench_Press": { name: "Reverse Band Bench Press", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "forearms", "lats", "upper back", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Sled_Overhead_Triceps_Extension": { name: "Sled Overhead Triceps Extension", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "other", category: "strength", mechanic: "isolation" },
  ...
  "Speed_Band_Overhead_Triceps": { name: "Speed Band Overhead Triceps", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "band", category: "strength", mechanic: "isolation" },
  ...
  "Standing_Towel_Triceps_Extension": { name: "Standing Towel Triceps Extension", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: [], equipment: "bodyweight", category: "strength", mechanic: "isolation" },
  "Tate_Press": { name: "Tate Press", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "front delts"], equipment: "dumbbell", category: "strength", mechanic: "isolation" },
  ...
  "Weighted_Bench_Dip": { name: "Weighted Bench Dip", aliases: [], primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "front delts"], equipment: "other", category: "strength", mechanic: "compound" },
  // ---- upper back ----
  "Alternating_Kettlebell_Row": { name: "Alternating Kettlebell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "kettlebell", category: "strength", mechanic: "isolation" },
  "Alternating_Renegade_Row": { name: "Alternating Renegade Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["abs", "biceps", "chest", "lats", "triceps"], equipment: "kettlebell", category: "strength", mechanic: "compound" },
  "Bent_Over_Barbell_Row": { name: "Bent Over Barbell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Bent_Over_One-Arm_Long_Bar_Row": { name: "Bent Over One-Arm Long Bar Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats", "lower back", "traps"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Bent_Over_Two-Arm_Long_Bar_Row": { name: "Bent Over Two-Arm Long Bar Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Bent_Over_Two-Dumbbell_Row": { name: "Bent Over Two-Dumbbell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats", "front delts"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  "Bent_Over_Two-Dumbbell_Row_With_Palms_In": { name: "Bent Over Two-Dumbbell Row With Palms In", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  ...
  "Dumbbell_Incline_Row": { name: "Dumbbell Incline Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "forearms", "lats", "front delts"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  ...
  "Inverted_Row": { name: "Inverted Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["lats"], equipment: "bodyweight", category: "strength", mechanic: "compound" },
  "Inverted_Row_with_Straps": { name: "Inverted Row with Straps", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "other", category: "strength", mechanic: "compound" },
  ...
  "Mixed_Grip_Chin": { name: "Mixed Grip Chin", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "other", category: "strength", mechanic: "compound" },
  "One_Arm_Chin-Up": { name: "One Arm Chin-Up", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "forearms", "lats"], equipment: "other", category: "strength", mechanic: "compound" },
  "One-Arm_Dumbbell_Row": { name: "One-Arm Dumbbell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats", "front delts"], equipment: "dumbbell", category: "strength", mechanic: "compound" },
  "One-Arm_Kettlebell_Row": { name: "One-Arm Kettlebell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "kettlebell", category: "strength", mechanic: "compound" },
  "One-Arm_Long_Bar_Row": { name: "One-Arm Long Bar Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "barbell", category: "strength", mechanic: "compound" },
  "Reverse_Grip_Bent-Over_Rows": { name: "Reverse Grip Bent-Over Rows", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats", "front delts"], equipment: "barbell", category: "strength", mechanic: "compound" },
  ...
  "Sled_Row": { name: "Sled Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "other", category: "strength", mechanic: "compound" },
  ...
  "Suspended_Row": { name: "Suspended Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "other", category: "strength", mechanic: "compound" },
  ...
  "Two-Arm_Kettlebell_Row": { name: "Two-Arm Kettlebell Row", aliases: [], primaryMuscles: ["upper back"], secondaryMuscles: ["biceps", "lats"], equipment: "kettlebell", category: "strength", mechanic: "compound" },
}
